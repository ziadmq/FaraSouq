...
export default function AuthLayout({ children, emailOrNameForCard, isRegister = false }: AuthLayoutProps) {
  ...
  return (
    <div className="w-full bg-[#11192a]/50 backdrop-blur-2xl border border-slate-800/80 flex items-center justify-center p-4 sm:p-6 md:p-10 relative overflow-hidden rounded-[2rem] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.5)]">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[60%] bg-emerald-500/15 rounded-full blur-[150px] pointer-events-none" />
        ...
        <div className="lg:col-span-5 text-right flex flex-col justify-between gap-8 text-white p-2 lg:p-4 order-2 lg:order-1 h-full min-h-[480px]">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-4 justify-end">
              <div>
                <h1 className="text-3xl lg:text-4xl font-extrabold bg-gradient-to-r from-emerald-400 via-yellow-200 to-emerald-300 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(251,191,36,0.3)]">
                  فارة | سوق
                </h1>
              </div>
              <div className="p-3 bg-[#152033] border border-[#2b3952] rounded-2xl shadow-xl hover:border-emerald-400/40 hover:rotate-6 transition-all duration-300">
          ...
          <div className="relative group perspective-1000 py-4 my-2">
            <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-yellow-300 rounded-2xl blur-lg opacity-25 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
            
            <motion.div 
              whileHover={{ rotateY: -10, rotateX: 5, scale: 1.02 }}
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              className="relative bg-[#172338]/95 border border-emerald-500/20 rounded-2xl p-6 shadow-2xl overflow-hidden min-h-[190px] flex flex-col justify-between"
            >
              <div className="absolute top-0 right-0 w-[150%] h-[150%] bg-gradient-to-tr from-transparent via-white/[0.03] to-emerald-300/[0.02] transform -translate-x-12 -translate-y-12 rotate-12 pointer-events-none" />
              
              <div className="flex justify-between items-start">
                <div className="w-10 h-8 rounded-md bg-gradient-to-br from-emerald-300 via-yellow-100 to-emerald-600 p-[1.5px] relative">
                  <div className="w-full h-full bg-[#18253c]/90 rounded-sm border-r border-[#2c3d59]" />
                  <div className="absolute top-[30%] left-0 w-full h-[1px] bg-emerald-200/40" />
                  <div className="absolute top-[60%] left-0 w-full h-[1px] bg-emerald-200/40" />
                  <div className="absolute left-[50%] top-0 w-[1px] h-full bg-emerald-200/40" />
                </div>
                <div className="flex items-center gap-1.5 uppercase tracking-wide font-mono text-xs font-black text-emerald-400/90">
              ...
              <div className="space-y-1 z-10">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="bg-[#111c2d] px-2.5 py-0.5 rounded-md border border-[#2b3c56] text-[10px] text-emerald-300 font-bold">
                    نشط ●
                  </div>
                </div>
              </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-center gap-2.5">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#121c2e] to-[#1c2c48] flex items-center justify-center border border-slate-700 font-bold text-xs text-emerald-400">
          ...
          <div className="grid grid-cols-3 gap-2 pb-1">
            {[
              { title: "تسليم فوري ومبرمج", icon: Zap, color: "text-emerald-400" },
