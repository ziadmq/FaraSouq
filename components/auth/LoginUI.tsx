        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-left">
            <span 
              ...
              className="text-xs text-[#a3b7dc] hover:text-emerald-400 transition-colors cursor-pointer bg-[#151f33]/60 px-2.5 py-1 rounded-lg border border-[#21314d] inline-block"
            >
              نسيت كلمة السر؟ 🔑
            </span>
          </div>
