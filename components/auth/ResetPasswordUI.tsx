      ...
      >
        ...
        <div className="mb-8 pb-6 border-b border-[#21314d]/60 flex flex-col items-start justify-start text-right w-full">
          <div className="flex items-center justify-start gap-3 mb-3">
            <div className="w-12 h-12 bg-amber-500/10 border border-amber-500/20 rounded-2xl flex items-center justify-center shadow-[0_0_15px_rgba(16,185,129,0.15)] shrink-0">
