...
import { Settings, Key, Plus, Trash2, Save, Tag, Type, Text, MousePointerClick, Image as ImageIcon, Link as LinkIcon, Upload, Calendar, Phone, Mail, Clock } from "lucide-react";
import { JoPaySettings, BannerSlide, ShippingProof, ContactSettings } from "../../types";
...
export default function CMSSettingsTab({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ====== CONTACT SETTINGS ====== */}
      <div className="bg-[#191f2f] rounded-2xl p-6 border border-[#4f4633]/40 space-y-5">
        <div className="flex items-center gap-3 pb-3 border-b border-[#4f4633]/20">
